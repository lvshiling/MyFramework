...
/**
 * JsonMapper.cs
 *   JSON to .Net System.Object and System.Object to JSON conversions.
 *
...
namespace LitJsonEx
{
    ...
    internal delegate void ExporterFunc    (System.Object obj, JsonWriter writer);
    public   delegate void ExporterFunc<T> (T obj, JsonWriter writer);

    internal delegate System.Object ImporterFunc                (System.Object input);
    ...
    public class JsonMapper
    {
        ...
        private static readonly System.Object array_metadata_lock = new System.Object ();

        private static IDictionary<Type,
                IDictionary<Type, MethodInfo>> conv_ops;
        private static readonly System.Object conv_ops_lock = new System.Object ();

        private static IDictionary<Type, ObjectMetadata> object_metadata;
        private static readonly System.Object object_metadata_lock = new System.Object ();

        private static IDictionary<Type,
                IList<PropertyMetadata>> type_properties;
        private static readonly System.Object type_properties_lock = new System.Object ();

        private static JsonWriter      static_writer;
        private static readonly System.Object static_writer_lock = new System.Object ();
        #endregion
        ...
        private static void RegisterBaseExporters ()
        {
            base_exporters_table[typeof (byte)] =
                delegate (System.Object obj, JsonWriter writer) {
        ...
        private static void RegisterBaseImporters ()
        {
            ...
            importer = delegate (System.Object input) {
        ...
        private static void WriteValue (System.Object obj, JsonWriter writer,
                                        bool writer_is_private,
                                        int depth)
        {
            if (depth > max_nesting_depth)
                throw new JsonException (
                    String.Format ("Max allowed System.Object depth reached while " +
            ...
            if (obj is Array) {
                ...
                foreach (System.Object elem in (Array) obj)
            ...
            if (obj is IList) {
                writer.WriteArrayStart ();
                foreach (System.Object elem in (IList) obj)
                    WriteValue (elem, writer, writer_is_private, depth + 1);
                writer.WriteArrayEnd ();
            ...
            foreach (PropertyMetadata p_data in props) {
                if (p_data.IsField) {
                    if (!(p_data.Info as FieldInfo).IsLiteral) {
        ...
        public static void ToJson (System.Object obj, JsonWriter writer)
        {
