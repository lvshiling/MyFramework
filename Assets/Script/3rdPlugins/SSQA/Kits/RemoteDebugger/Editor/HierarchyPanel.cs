...
namespace RemoteDebugger { 
    public class HierarchyPanel : EditorWindow {
        ...
        public static void OnShowWindow() {
			var wnd = GetWindow<HierarchyPanel>();
			wnd.m_szIPAddr = PlayerPrefs.GetString("RemoteDebuggerIP");
			wnd.Show();
		}
...
#region SetGameObjectLayer
    ...
    //     }
		...
		private static Color pro = Color.white;
		private static Color free = Color.black;
        ...
        void InitUIStyle() {
            ...
            m_uiStyleActive.normal.textColor = EditorGUIUtility.isProSkin? pro: free;
            m_uiStyleInActive.normal.textColor = Color.red;
            m_uiStyleSelected.normal.textColor = Color.blue;
            m_LabelStyleActive.normal.textColor = EditorGUIUtility.isProSkin? pro: free;
        ...
        void Update() {
			...
			if (lastShowObjNum != ShowPanelDataSet.ms_lstRootRDObjs.Count)
			{
				Repaint();
			}
        }
